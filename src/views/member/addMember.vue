    ...
    export default {
        ...
        data() {
            return {
                ...
                isMale:true,
                pickerVisible:false,
                markList:["标签1","标签1","标签1","标签1","标签1","标签1","标签1","标签1"]
            };
        },
...
textarea{width: 100%;height: 1.6rem;outline: none;padding: 0.20rem 0.30rem;font-size: 0.28rem;}
.markDiv{background-color: #fff; padding:0.24rem 0.24rem 0.40rem;}
.markList i{display:inline-block;background-color: #fff;border: 1px #ccc solid;color: #ccc;width: 1.5rem;height: 0.54rem;line-height: 0.52rem; border-radius:0.27rem;margin-right: 0.24rem;font-size: 0.24rem;margin-top: 0.20rem;text-align: center;}
.markList i.active{background: linear-gradient(left,#ff8000,#ff5000);border:1px #ff6600 solid; color: #fff;}
